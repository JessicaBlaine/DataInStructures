...
/***/ function(module, exports, __webpack_require__) {
	...
	document.addEventListener("DOMContentLoaded", function () {
	  var $rootEl = $("#root");
	  var $title = $rootEl.find('.js-title');
	  var copy = '.js-copy';
...
/***/ function(module, exports, __webpack_require__) {
	...
	ArrayView.prototype.pop = function (event) {
	  ...
	  var removeEl = function removeEl() {
	    $(".el-" + (_this.array.length - 1)).remove();
	    _this.array.pop();
	    anime({
	      targets: [".array__el"],
	...
	ArrayView.prototype.push = function (event) {
	  ...
	  if (this.array.length > 10) {
	    ...
	    if (value) {
	      (function () {
	        var $element = $("<li>" + value + "</li>").addClass("array__el el-hidden el-" + _this2.array.length).prepend("<div>" + _this2.array.length + "</div>");
	        _this2.array.push(value);
	        _this2.$array.find("ul").append($element);
	        setTimeout(function () {
	          return $element.removeClass("el-hidden");
	        }, 300);
	
	        _this2.getIndex(event, _this2.array.length - 1);
	      })();
	    }
	  }
	};
	...
	ArrayView.prototype.setIndex = function (event) {
	  // $('.method button').prop("disabled", true);
	  console.log("set");
	  var idx = parseInt($(event.target).prev().val());
	  var value = $(event.target).next().val();
	...
	ArrayView.prototype.getIndex = function (event, i) {
	  ...
	  var idx = i || parseInt($(event.target).next().val());
	  if (!Number.isNaN(idx)) {
	    $('.method button').prop("disabled", true);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  resetPointer: function resetPointer() {
	  ...
	  getIndex: function getIndex(idx) {
	    ...
	    var revealVal = function revealVal() {
	      anime({
	        targets: ".el-" + idx + " div",
	        opacity: 0
	      });
	  ...
	  outOfBounds: function outOfBounds(length) {
	    function bounceBack() {
	      console.log("BB");
	  ...
	  revealPointer: function revealPointer(complete) {
	    anime({
	      targets: ".js-pointer",
	      duration: 500,
	      opacity: "1",
